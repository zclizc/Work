...
Page({
  ...
  onLoad (params) {
    ...
    var that = this;
    https.classify('Gateway/route?method=pingshifen.question.special&course_id=' + wx.getStorageSync('jiaoxue_addedCourse'),{subject:params.subject,type:params.type}).then((data) =>{
